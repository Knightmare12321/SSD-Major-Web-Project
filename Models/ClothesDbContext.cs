...
public partial class ClothesDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PkDiscountCode).HasName("PK__Discount__79BE3D845C6F1B47");
        ...
        {
            entity.HasKey(e => e.PkOrderId).HasName("PK__Order__C196130BBEE66140");
        ...
        {
            entity.HasKey(e => new { e.FkOrderId, e.FkSkuId }).HasName("PK__OrderDet__1F82522DC190C2B7");
        ...
        {
            entity.HasKey(e => e.PkOrderStatusId).HasName("PK__OrderSta__ABDB6887254916FB");
        ...
        {
            entity.HasKey(e => e.PkProductId).HasName("PK__Product__4492A4B5753387E4");
        ...
        {
            entity.HasKey(e => e.PkSkuId).HasName("PK__ProductS__B7ADEE3BC1CE313B");
        ...
        {
            entity.HasKey(e => new { e.FkUserId, e.FkProductId }).HasName("PK__Review__4651880718AEEDD1");
        ...
        {
            entity.HasKey(e => e.PkUserId).HasName("PK__User__1790FCDFB7836A75");
            ...
            entity.HasOne(d => d.FkUserType).WithMany(p => p.Users)
                ...
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("UserUserTypeFK");
        });

        modelBuilder.Entity<UserType>(entity =>
        {
            entity.HasKey(e => e.PkUserTypeId).HasName("PK__UserType__F1FCA1421A9A06B0");
